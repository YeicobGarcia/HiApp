...
import com.example.hiapp.Adaptadores.AdapterMensajesGrupal;
...
public class ChatGrupal extends AppCompatActivity {
    ...
    public void obtenerMensajesGrupal() {
        listaMensajes.clear();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, getResources().getString(R.string.URL_OBTENER_MENSAJES_GRUPAL),
    ...
    public void enviarMensaje() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, getResources().getString(R.string.URL_ENVIAR_MENSAJE_GRUPAL),
                new Response.Listener<String>() {
